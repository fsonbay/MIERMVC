...
(function ($) {
    ...
    _$lineCalc.keyup(function (event) {
        ...
        var quantityName = 'input[name="PurchaseLines[' + index + '].Quantity"]';
        var priceName = 'input[name="PurchaseLines[' + index + '].Price"]';
        var amountName = 'input[name="PurchaseLines[' + index + '].Amount"]';
    ...
    function ReorderIndex() {
        $(".line-set").each(function () {
            ...
            //   //select2-PurchaseLines_0__CategoryId - container
    ...
    function ResetValidator() {
        //Reset validator
        $('#FormPurchase').removeData('validator');
        $('#FormPurchase').removeData('unobtrusiveValidation');
        $.validator.unobtrusive.parse('#FormPurchase');
    }
